...
#define IMC_VERSION_ID "IMC2 AntiFreeze CL-2 "
...
typedef struct imc_routerinfo ROUTERINFO;      /* The given mud :) */
...
struct imc_routerinfo
{
   char *routername;		/* name of router */
   char *host;			/* DNS/IP of router */
   ...
   unsigned short port;		/* remote port of router */
